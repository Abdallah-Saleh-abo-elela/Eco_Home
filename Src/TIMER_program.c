...
/* MCAL Includes */
#include "../Inc/MCAL/TIMER/TIMER_interface.h"
#include "../Inc/MCAL/TIMER/TIMER_private.h" /*You have to include TIMER_private.h before TIMER_config.h*/
#include "../Inc/MCAL/TIMER/TIMER_config.h"
